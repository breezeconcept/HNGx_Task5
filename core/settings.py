...
SECRET_KEY = 'django-insecure-0(o-d-k8ckv*x=#hr&5ll(_j_*!ikds#qndr5xa*^gk49hc#yi'
...
#         'PORT': '',  # Leave empty to use the default port (3306)
#     }
# }
...
# Configure media root and URL for uploaded files
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Configure CORS settings
# CORS_ALLOWED_ORIGINS = [
#     "http://localhost:8080",  # Add your frontend's URL
# ]
